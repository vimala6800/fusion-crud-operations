...
export interface ICreateRequisitionCommand {
  RequisitionCode?: string | undefined;
  PotentialNumber?: string;
  complexity?: string;
  RequisitionDate: Date;
  DeadlineDate: Date;
  ClinetCuntryID: string;
  ClientName: string;
  ProjectType: string;
...
export class RequisitionClient implements IRequisitionClient {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
  ...
  get(): Observable<RequisitionVm> {
    let url_ = this.baseUrl + "/api/requisition";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
      ...
      if (response_ instanceof HttpResponseBase) {
        try {
          ...
          return _observableThrow(e) as any as Observable<RequisitionVm>;
        }
      } else
        return _observableThrow(response_) as any as Observable<RequisitionVm>;
    }));
  }
  ...
  getRequesition() {
    return this.http.get<any>("https://localhost:7184/api/Requisition");
 }

  protected processGet(response: HttpResponseBase): Observable<RequisitionVm> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse ? response.body :
        (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    if (status === 200) {
      return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
        let result200: any = null;
        let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
        result200 = RequisitionVm.fromJS(resultData200);
        return _observableOf(result200);
      }));
    } else if (status !== 200 && status !== 204) {
      return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class CreateRequisitionCommand implements ICreateRequisitionCommand {
  RequisitionCode?: string | undefined;
  PotentialNumber?: string;
  complexity?: string;
  RequisitionDate: Date;
  ...
  constructor(data?: ICreateRequisitionCommand) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  init(_data?: any) {
    if (_data) {
      this.RequisitionCode = _data["RequisitionCode"];
      this.PotentialNumber = _data["PotentialNumber"];
      this.complexity = _data["complexity"];
      this.RequisitionDate = _data["RequisitionDate"];
      this.DeadlineDate = _data["DeadlineDate"];
      this.ClinetCuntryID = _data["ClinetCuntryID"];
      this.ClientName = _data["ClientName"];
      this.ProjectType = _data["ProjectType"];
      this.RequisitionStatus = _data["RequisitionStatus"];
      this.ExpectedStartDate = _data["ExpectedStartDate"];
  ...
  static fromJS(data: any): CreateRequisitionCommand {
    data = typeof data === 'object' ? data : {};
    let result = new CreateRequisitionCommand();
    result.init(data);
    return result;
  }
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {};
    data["RequisitionCode"] = this.RequisitionCode;
    data["PotentialNumber"] = this.PotentialNumber;
    data["complexity"] = this.complexity;
    data["RequisitionDate"] = this.RequisitionDate;
    data["DeadlineDate"] = this.DeadlineDate;
    data["ClinetCuntryID"] = this.ClinetCuntryID;
...
export interface IRequisitionClient {
  get(): Observable<RequisitionVm>;
  //create(command: CreateTodoListCommand): Observable<number>;
  //get2(id: number): Observable<FileResponse>;
  //update(id: number, command: UpdateTodoListCommand): Observable<FileResponse>;
...
export class RequisitionDto implements IRequisitionDto {
  ...
  CurrencyID?: string;
  ProjectDescription?: string;
  items?: RequisitionSkillsDto[];

  constructor(data?: IRequisitionDto) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  init(_data?: any) {
    if (_data) {
      this.RequisitionId = _data["RequisitionID"];
      this.RequisitionCode = _data["RequisitionCode"];
      this.PotentialNumber = _data["PotentialNumber"];
      this.Complexity = _data["Complexity"];
      this.RequisitionDate = _data["RequisitionDate"];
      this.DeadlineDate = _data["DeadlineDate"];
      this.ClientName = _data["ClientName"];
      this.ClientCountryID = _data["ClientCountryID"];
      this.ProjectType = _data["ProjectType"];
      this.RequisitionStatus = _data["RequisitionStatus"];
      this.ExpectedStartDate = _data["ExpectedStartDate"];
      this.Budget = _data["Budget"];
      ...
      if (Array.isArray(_data["items"])) {
        this.items = [] as any;
        for (let item of _data["items"])
          this.items!.push(RequisitionSkillsDto.fromJS(item));
      }
    }
  }

  static fromJS(data: any): RequisitionDto {
    data = typeof data === 'object' ? data : {};
    let result = new RequisitionDto();
    result.init(data);
    return result;
  }
  ...
  toJSON(data?: any) {
    ...
    data["DeadlineDate"] = this.DeadlineDate;
    data["ClientName"] = this.ClientName;
    data["ClientCountryID"] = this.ClientCountryID;
    data["ProjectType"] = this.ProjectType;
    data["RequisitionStatus"] = this.RequisitionStatus;
    data["ExpectedStartDate"] = this.ExpectedStartDate;
    data["Budget"] = this.Budget;
...
export interface IRequisitionDto {
  RequisitionId?: string;
  RequisitionCode?: string;
  PotentialNumber?: string;
  Complexity?: string;
...
export class RequisitionVm implements IRequisitionVm {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["lists"])) {
        this.lists = [] as any;
        for (let item of _data["lists"])
          this.lists!.push(RequisitionDto.fromJS(item));
      }
    }
  }

  static fromJS(data: any): RequisitionVm {
    data = typeof data === 'object' ? data : {};
    let result = new RequisitionVm();
    result.init(data);
    return result;
  }
...
export interface IRequisitionVm {
  lists?: RequisitionDto[];
}


export class RequisitionSkillsDto implements IRequisitionSkillsDto {
  RequisitionSkillID: string;
  RequisitionID: string;
  SkillID: string;
  Skil: String;
  Mandatory: number;
  ...
  constructor(data?: IRequisitionSkillsDto) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  init(_data?: any) {
    if (_data) {
      this.RequisitionSkillID = _data["RequisitionSkillID"];
      this.RequisitionID = _data["RequisitionID"];
      this.SkillID = _data["SkillID"];
      this.Skil = _data["Skil"];
  ...
  static fromJS(data: any): RequisitionSkillsDto {
    data = typeof data === 'object' ? data : {};
    let result = new RequisitionSkillsDto();
    result.init(data);
    return result;
  }
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {};
    data["RequisitionSkillID"] = this.RequisitionSkillID;
    data["RequisitionID"] = this.RequisitionID;
...
export interface IRequisitionSkillsDto {
  RequisitionSkillID?: string;
  RequisitionID: string;
  SkillID: string;
  Skil: String;
