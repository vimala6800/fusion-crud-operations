...
namespace PartnerPortal.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221216051422_requestionSkill&Partner1Migration")]
    partial class requestionSkillPartner1Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartnerPortal.Domain.Entities.RequisitionPartner", b =>
                {
                    ...
                    b.Property<Guid>("requestionIdRequisitionID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("requestionIdRequisitionID");

                    b.ToTable("RequisitionPartner");
                });
            ...
            modelBuilder.Entity("PartnerPortal.Domain.Entities.Requisition", b =>
                {
                    b.HasOne("PartnerPortal.Domain.Entities.Country", "CountryId")
                        .WithMany()
                        .HasForeignKey("CountryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PartnerPortal.Domain.Entities.Currency", "CurrencyId")
                        .WithMany()
                        .HasForeignKey("CurrencyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PartnerPortal.Domain.Entities.Department", "DepartmentId")
                        .WithMany()
            ...
            modelBuilder.Entity("PartnerPortal.Domain.Entities.RequisitionFile", b =>
                {
                    b.HasOne("PartnerPortal.Domain.Entities.Requisition", "requisitionId")
                        .WithMany("requisitionFiles")
                        .HasForeignKey("RequisitionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("requisitionId");
                });
            ...
            modelBuilder.Entity("PartnerPortal.Domain.Entities.RequisitionPartner", b =>
                {
                    b.HasOne("PartnerPortal.Domain.Entities.Partner", "partnerId")
                        .WithMany()
                        .HasForeignKey("PartnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PartnerPortal.Domain.Entities.Requisition", "requestionId")
                        .WithMany("requisitionPartners")
                        .HasForeignKey("requestionIdRequisitionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("partnerId");

                    b.Navigation("requestionId");
                });
